...
2. [Illumina Data](#a-illumina-data)
3. [Downloading raw data](#downloading-raw-data)
4. [Running the FastQC tool](#step-1-open-the-terminal-and-change-your-working-directory-to-the-directory-with-the-files-for-this-practical-which-is-a-folder-called-cp2)
5. [Basic statistics](#basic-statistics)
6. [Per base sequence quality](#per-base-sequence-content)
7. [Per sequence quality scores](#per-base-sequence-quality)
8. [Per base sequence content](#per-base-n-contentt)
9. [Per sequence GC content](#per-sequence-gc-content)
10. [Per base N content](#per-base-n-content)
11. [Sequence duplication levels](#sequence-duplication)
12. [Adapter content](#adapter-content)
13. [QC Exercise and Quiz](#qc-exercise-and-quiz)
14. [Filtering and trimming of sequence reads](#step-5-filtering-and-trimming-of-sequence-reads)
15. [Trimming Exercise and Quiz](#trimming-exercise-and-quiz)
16. [Nanopore Data Access and Quality Control (ONT)](#nanopore-data-access-and-quality-control-ont)
17. [Retrieve ONT reads and Running the NanoQC tool](#step-1-retrieving-nanopore-data-from-ena)
18. [Adapter Trimming with Porechop](#step-4-adapter-trimming-with-porechop)
19. [Filtering Reads with Filtlong](#step-5-filtering-reads-with-filtlong)
...
## Step 5: Filtering and trimming of sequence reads<a name="filttrim"></a>
...
* Length
* Quality
* Percent of reads to keep
Basic Filtering Example
Keep best 90% of reads:
```
